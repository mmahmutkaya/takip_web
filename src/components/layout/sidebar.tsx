...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 border-r border-slate-400/60 bg-[hsl(214_16%_84%)] flex flex-col h-screen sticky top-0 z-10 shadow-[inset_-1px_0_0_rgba(100,116,139,0.35)]">
